...
* SQL
  * MySQL
    ...
    * [How to install MySQL on Ubuntu 20.04 | phoenixNAP](https://phoenixnap.com/kb/install-mysql-ubuntu-20-04)
    * [MySQL Shell 8.0 documentation](https://downloads.mysql.com/docs/mysql-shell-8.0-en.pdf)
* AWS
  ...
  * [Using SSL/TLS to encrypt a connection to a DB cluster | AWS Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.SSL.html)
  ...
  * [Security with Amazon Aurora MySQL | AWS Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Security.html)
  * [How can I troubleshoot connectivity to an Amazon RDS DB instance that uses a public or private subnet of a VPC? | AWS re:Post](https://repost.aws/knowledge-center/rds-connectivity-instance-subnet-vpc)
  * [Simple Serverless FastAPI with AWS Lambda by Sean Baier](https://www.deadbear.io/simple-serverless-fastapi-with-aws-lambda/)
  * AWS CLI
    * [AWS CLI RDS describe-certificates](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-certificates.html)
* CI/CD and Flyway
  * [How Can We Use Flyway with Gitlab CI/CD Pipeline by Hasan Kadir Demircan on Nov 18, 2022 | Medium](https://hkdemircan.medium.com/how-can-we-use-flyway-with-gitlab-ci-cd-pipeline-88f694cc0ca3)
...
* [Google Search: Get pem certificate for RDA Aurora MySQL database](https://www.google.com/search?q=Get+pem+certificate+for+RDA+Aurora+MySQL+database&sxsrf=APwXEdcY7bfxuepRb5G0MqDIGtgKEXbPFA%3A1684617242167&source=hp&ei=GjhpZO_kBpyu0PEPzbWToAY&iflsig=AOEireoAAAAAZGlGKofk79h4V98xNoEcx94OgzEpGwwX&ved=0ahUKEwjv2bGi6IT_AhUcFzQIHc3aBGQQ4dUDCAw&uact=5&oq=Get+pem+certificate+for+RDA+Aurora+MySQL+database&gs_lcp=&sclient=gws-wiz)
* [Google Search: AWS Amazon RDS Aurora MySQL access my publicly available database](https://www.google.com/search?q=AWS+Amazon+RDS+Aurora+MySQL+access+my+publicly+available+database&sxsrf=APwXEddyCuWuP0yyPIlWgOI4SH9KWQXYiQ%3A1684611730466&source=hp&ei=kiJpZMfUGeqC0PEP_eCDoAI&iflsig=AOEireoAAAAAZGkwoso-zK8X05EmXOD6pMVF32SCU8v2&ved=0ahUKEwjH5Zre04T_AhVqATQIHX3wACQQ4dUDCAw&uact=5&oq=AWS+Amazon+RDS+Aurora+MySQL+access+my+publicly+available+database&gs_lcp=&sclient=gws-wiz)
